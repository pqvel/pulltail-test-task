...
import { TableRow, TableColumn } from "../ui/table";
...
import { fullPartialValues } from "../../core/constants";
...
<template>
  <tr class="table-item d-flex" @click="handleClick">
    <td class="p-0">
      <table>
        <TableRow>
          ...
          <TableColumn className="justify-content-between">
            ...
            <div class="d-flex flex-column align-items-end">
              ...
              <span class="text-secondary"> {{ load.company.dtp }} DTP </span>
            </div>
          </TableColumn>
        </TableRow>
      </table>

      <tr class="load-info d-flex w-100 bg-white" v-if="active">
        <td class="load-info-column d-flex flex-column p-1 me-2 bg-transparent">
          <div
          ...
          <div class="d-flex justify-content-between mt-2">
            <div class="d-flex flex-column pl-2">
              ...
              <span class="fw-bold">
                {{ load.addressDropOff.city }}, {{ load.addressDropOff.state }},
          ...
          <table class="mt-3">
            ...
            <tr>
              ...
              <td class="d-flex align-items-center fw-bolder">
                ...
                <BIconInfoCircleFill width="14" height="14" fill="#b4b4b4" />
              </td>
            </tr>
          </table>
          <div
